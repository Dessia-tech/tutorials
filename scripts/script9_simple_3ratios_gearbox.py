...
speed = [[800, 1800], [800,1800], [1800,3200], [800, 3200], [800, 3200], [800, 3200],
         [800, 1100],[1100, 3200], [1100, 3200], [1600, 3200], [1600, 2400], [2400, 3200],
         [2000,3200]]
torque= [[0,12],[12,18],[0,18],[18,25], [25,35], [35,50], [55, 80],[50,70],[70,95],[85,105],
         [105,125], [105,125],[125,160]]
...
optimizer = objects.GearBoxOptimizer(gearbox = gearbox, ratios_min_max = [0.5,4.2],
                                     speeds = speeds, torques = torques, number_ratios = 3)
