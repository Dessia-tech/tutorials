...
c = p1.plot_data()
plot_data.plot_canvas(c, canvas_id='canvas', debug_mode=True)
...
plot_data.plot_canvas(primitives, canvas_id='canvas', debug_mode=False)
...
plot_data.plot_canvas(cs, canvas_id='canvas', debug_mode=True)